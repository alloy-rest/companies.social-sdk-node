import fs from 'fs';
import type { ResponseLike } from '@alloy.rest/companies.social/internal/to-file';
import { toFile } from '@alloy.rest/companies.social/core/uploads';
...
describe('missing File error message', () => {
  ...
  test('is thrown', async () => {
    const uploads = await import('@alloy.rest/companies.social/core/uploads');
    await expect(
